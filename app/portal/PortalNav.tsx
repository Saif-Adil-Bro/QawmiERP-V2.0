...
import { LayoutDashboard, Calendar, GraduationCap, CreditCard } from "lucide-react";
...
export default function PortalNav() {
  ...
  const links = [
    ...
    { href: "/portal/academic", label: "Academic & Hifz", icon: GraduationCap },
    { href: "/portal/fees", label: "Fee Status", icon: CreditCard },
  ];
