...
export default function TeacherShell({ user, userData, children }: TeacherShellProps) {
  ...
  const bottomNavItems = [
    { href: "/teacher-portal", label: "হোম", icon: LayoutDashboard, exact: true },
    { href: "/teacher-portal/attendance", label: "হাজিরা", icon: Calendar },
    { href: "/teacher-portal/hifz", label: "হিফজ", icon: BookOpen },
    { href: "/teacher-portal/kitab", label: "কিতাবাত", icon: FileText },
    { href: "/teacher-portal/exams", label: "নম্বর", icon: ClipboardList },
  ];
        ...
        <div className="p-4 bg-slate-900/90 border-b border-slate-800 flex items-center justify-between">
          <Link href="/teacher-portal" className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <span className="text-base font-bold text-white tracking-tight block truncate">শিক্ষক পোর্টাল</span>
              <span className="text-[11px] font-medium text-emerald-400 block truncate">Teacher Workspace</span>
            </div>
          </Link>
        </div>
        ...
        <div className="p-3.5 bg-slate-900/90 border-t border-slate-800 space-y-2">
          ...
          <div className="flex items-center gap-3 p-2 bg-slate-800/50 rounded-xl border border-slate-700/50">
            ...
            <div className="overflow-hidden min-w-0 flex-1">
              <p className="text-xs font-bold text-white truncate">{userData?.full_name || "মুহতারাম শিক্ষক"}</p>
          ...
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-slate-950 text-slate-300 z-10 shadow-2xl border-r border-slate-800 animate-in slide-in-from-left duration-200">
            <div className="p-4 bg-slate-900 flex items-center justify-between border-b border-slate-800">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-sm font-bold text-white">শিক্ষক পোর্টাল</span>
              </div>
              <button
                onClick={() => setIsMobileMenuOpen(false)}
            ...
            <TeacherNav onItemClick={() => setIsMobileMenuOpen(false)} />
        ...
        <header className="md:hidden bg-slate-900 text-white px-4 py-3 border-b border-slate-800 flex items-center justify-between shrink-0 shadow-md">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-sm tracking-tight">শিক্ষক পোর্টাল</span>
            </div>
          </div>
