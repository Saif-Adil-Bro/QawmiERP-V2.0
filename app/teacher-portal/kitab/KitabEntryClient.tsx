                    ...
                    <tr key={s.id} className="hover:bg-slate-50/60 transition">
                      <td className="px-4 py-3.5">
                        <div className="flex items-center gap-2.5">
                          <div className="w-9 h-9 rounded-full bg-indigo-100 text-indigo-700 flex items-center justify-center font-bold text-xs shrink-0 overflow-hidden border border-indigo-200 shadow-2xs">
                            {s.photo_url ? (
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-1.5 text-[11px] text-slate-500 mt-0.5">
                              ...
                              {s.phone && (
                                <>
                                  <span>•</span>
                                  <a href={`tel:${s.phone}`} className="text-blue-600 hover:underline inline-flex items-center gap-0.5">
              ...
              return (
                <div key={s.id} className="p-4 space-y-2.5 bg-white">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-indigo-100 text-indigo-700 flex items-center justify-center font-bold text-xs shrink-0 overflow-hidden border border-indigo-200">
                        {s.photo_url ? (
                          <img src={s.photo_url} alt="" className="w-full h-full object-cover" />
                        ) : (
                          <span>{s.first_name?.[0] || "শ"}</span>
                    ...
                    <span className="text-xs font-bold text-indigo-800 bg-indigo-50 px-2.5 py-0.5 rounded-lg shrink-0">
