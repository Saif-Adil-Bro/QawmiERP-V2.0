...
export default async function AcademicHolidaysPage() {
  ...
  const normalizedMadrasa = {
    ...rawMadrasa,
    id: rawMadrasa.id || "",
    name: rawMadrasa.name || "মাদরাসা",
    address: rawMadrasa.address || "",
    phone: rawMadrasa.phone || rawMadrasa.contact_phone || "",
    email: rawMadrasa.email || rawMadrasa.contact_email || "",
    registration_no: rawMadrasa.registration_no || rawMadrasa.reg_no || "",
    established_year: rawMadrasa.established_year || "",
    principal_name: rawMadrasa.principal_name || "",
